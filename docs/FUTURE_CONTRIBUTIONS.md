...
Currently Nexus-MCP supports two local models (jina-code, bge-small-en) with GPU/MPS auto-detection. Add support for external embedding providers so users can trade latency for quality.
